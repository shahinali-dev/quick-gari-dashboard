...
import type { GetCarRegistrationParams } from "@/hooks";
import { useDebounce } from "@/hooks";
import { Search, X } from "lucide-react";
import { useEffect, useRef, useState } from "react";

interface CarRegistrationFiltersProps {
  params: GetCarRegistrationParams;
  onParamsChange: (params: GetCarRegistrationParams) => void;
  isLoading?: boolean;
}

export default function CarRegistrationFilters({
  params,
  onParamsChange,
  isLoading = false,
}: CarRegistrationFiltersProps) {
